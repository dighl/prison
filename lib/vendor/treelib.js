...
//Export code added 2015-10-28 by Jakob Runge <mam09crm@studserv.uni-leipzig.de>:
if(typeof(define) === 'function'){
  return define(function(){
    return {
      ...
      'circeArcPath': circeArcPath,
      'drawCircleArc': drawCircleArc,
      'drawPath': drawPath,
      ...
      'RectangleTreeDrawer': RectangleTreeDrawer,
      'PhylogramTreeDrawer': PhylogramTreeDrawer,
      'CircleTreeDrawer': CircleTreeDrawer,
      'CirclePhylogramDrawer': CirclePhylogramDrawer,
      'RadialTreeDrawer': RadialTreeDrawer,
      'uniqueid': uniqueid,
      'draw_tree_labels': draw_tree_labels,
      'draw_tree': draw_tree,
      ...
      'pan_btn': pan_btn,
      'pan_to_mouse': pan_to_mouse,
      'panning': panning,
      'pan_pressed': pan_pressed,
      'start_pan': start_pan,
      'stop_pan': stop_pan,
      'gradual_pan': gradual_pan,
      'zooming': zooming,
      'zoom_pressed': zoom_pressed,
      'start_zoom': start_zoom,
      'stop_zoom': stop_zoom,
      'gradual_zoom': gradual_zoom,
