"use strict";
define(['lib/vendor/FileSaver','lib/vendor/treelib'], function(saveAs, treelib){
  ...
  function showTree(newick, drawing_type)
  {
    ...
    /* initialize the tree */
    treelib.draw_tree(newick, drawing_type);
    $('text').dblclick(function (event){
      window.alert("Do you want to edit the node «"+event.target.textContent+"»?");
    }).css('cursor','pointer');
  }
